...
if __name__ == '__main__':
    ...
    start_t = time.time()
    train_inputs, _ = load_dataset(True, train_data, args.batch_size, args.feature_size, args.window_size, all_company_ids)
    valid_inputs, _ = load_dataset(True, valid_data, args.batch_size, args.feature_size, args.window_size, all_company_ids)
    end_t = time.time()
