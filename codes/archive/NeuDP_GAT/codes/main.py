...
if __name__ == '__main__':
    ...
    start_t = time.time()
    train_all_inputs, _ = load_dataset(True, train_data, args.batch_size, args.feature_size, args.window_size, all_company)
    end_t = time.time()
    ...
    final_save_path = os.path.join(model_dir, 'last_weights', f'{args.model_name}_checkpoint_{args.n_cluster}.pt')
