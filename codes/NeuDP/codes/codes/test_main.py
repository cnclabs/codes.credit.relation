...
def setup_wandb(args):
    ...
    wandb.init(
        ...
        "gamma": args.gamma,
        "architecture": f"GRU_{args.lstm_num_units}_dropout={args.dropout_rate}",
        "dataset": f"{args.data_dir}",
        "epochs": f"{args.num_epochs}",
        }
    )
