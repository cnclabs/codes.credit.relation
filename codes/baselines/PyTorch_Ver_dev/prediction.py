...
def evaluate_sess(model, dataloader, model_dir, params=None, file_type='test'):
...
def prediction(dataloader, model_dir, params, restore_from, device, file_type):
    """Evaluate the model"""
    ...
    evaluate_sess(model, dataloader, model_dir, params=params, file_type=file_type)
