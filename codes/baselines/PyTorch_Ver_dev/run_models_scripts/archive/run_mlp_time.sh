...
for i in {01..13};
do
    python ../main.py --model_dir=../../experiments/mlp01/time_fold_${i} --data_dir=../../data/8_labels_time/len_01/time_fold_${i} --device=cpu
done
...
for i in {01..13};
do
    python ../main.py --model_dir=../../experiments/mlp06/time_fold_${i} --data_dir=../../data/8_labels_time/len_06/time_fold_${i} --device=cpu
done
...
for i in {01..13};
do
    python ../main.py --model_dir=../../experiments/mlp12/time_fold_${i} --data_dir=../../data/8_labels_time/len_12/time_fold_${i} --device=cpu
done
