...
def main(pred_file, label_file, max_epoch, patience, batch_size, learning_rate, weight_decay, gamma):
    ...
    h_params = {'max_epoch': max_epoch, 'patience': patience, 'batch_size': batch_size, 'learning_rate': learning_rate, 'weight_decay': weight_decay, 'gamma': gamma}
