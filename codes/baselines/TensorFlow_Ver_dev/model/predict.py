...
def evaluate_sess(sess, model_dir, model_spec, num_steps, writer=None, params=None, file_type='test'):
    ...
    # write file
    predict_path = os.path.join(model_dir, f'pred_{file_type}.csv')
...
def prediction(model_spec, model_dir, params, restore_from, file_type):
    """Evaluate the model
    ...
    with tf.Session() as sess:
        ...
        evaluate_sess(sess, model_dir, model_spec, num_steps, params=params, file_type=file_type)
