...
for i in {01..13};
do
    python ../train.py --model_dir=../../experiments/gru01_index/index_fold_${i} --data_dir=../../data/8_labels_index/len_01/index_fold_${i} --device=0
done
...
for i in {01..13};
do
    python ../train.py --model_dir=../../experiments/gru06_index/index_fold_${i} --data_dir=../../data/8_labels_index/len_06/index_fold_${i} --device=0
done
...
for i in {01..13};
do
    python ../train.py --model_dir=../../experiments/gru12_index/index_fold_${i} --data_dir=../../data/8_labels_index/len_12/index_fold_${i} --device=0
done
