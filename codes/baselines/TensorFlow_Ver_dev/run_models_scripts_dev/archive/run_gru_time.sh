...
for i in {01..13};
do
    python ../train.py --model_dir=../../experiments/gru01/time_fold_${i} --data_dir=../../data/8_labels_time/len_01/time_fold_${i} --device=0
done
...
for i in {01..13};
do
    python ../train.py --model_dir=../../experiments/gru06/time_fold_${i} --data_dir=../../data/8_labels_time/len_06/time_fold_${i} --device=0
done
...
for i in {01..13};
do
    python ../train.py --model_dir=../../experiments/gru12/time_fold_${i} --data_dir=../../data/8_labels_time/len_12/time_fold_${i} --device=0
done
