...
parser.add_argument('--device', default='cpu',
                    help="CUDA_DEVICE")
parser.add_argument('--all_company_ids_path', default=False, help="path to list of all company ids")
parser.add_argument('--batch_size', default=1, type=int, required=False)


def predict_folds(exp_dir, data_file, pred_file, label_dir, label_file, split_type, device, batch_size, all_company):
...
if __name__ == "__main__":
    ...
    predict_folds(args.exp_dir, args.data_file,
            args.pred_file, args.label_dir, args.label_file, args.split_type, args.device, args.batch_size, args.all_company_ids_path)