...
do
    echo fold $i
    python ./explainable_credit/codes/main.py --model_dir=./explainable_credit/experiments/gru12/time_fold_${i} --data_dir=./data/8_labels_time/len_12/time_fold_${i} --device=2
done
python ./explainable_credit/codes/pred_folds.py --exp_dir=./explainable_credit/experiments/gru12/ --label_dir=./data/8_labels_time/len_12/ --device=2 --split_type "time"
