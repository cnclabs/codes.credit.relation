...
do
    echo fold $i
    python ./explainable_credit/codes/main.py --model_dir=./explainable_credit/experiments/gru06/time_fold_${i} --data_dir=./data/8_labels_time/len_06/time_fold_${i} --device=1
done
python ./explainable_credit/codes/pred_folds.py --exp_dir=./explainable_credit/experiments/gru06/ --label_dir=./data/8_labels_time/len_06/ --device=1 --split_type "time"
