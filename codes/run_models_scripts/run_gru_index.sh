...
do
    ...
    do
        ...
        # clean test_metrics_eval_best_weights.json
        if [ -f "${model_path}/gru${window_size}${model_path_suffix}/${dataset_type}_fold_${i}/test_metrics_eval_best_weights.json" ]
        then
            rm ${model_path}/gru${window_size}${model_path_suffix}/${dataset_type}_fold_${i}/test_metrics_eval_best_weights.json
        fi
        # clean test_metrics_eval_last_weights.json
        if [ -f "${model_path}/gru${window_size}${model_path_suffix}/${dataset_type}_fold_${i}/test_metrics_eval_last_weights.json" ]
        then
            rm ${model_path}/gru${window_size}${model_path_suffix}/${dataset_type}_fold_${i}/test_metrics_eval_last_weights.json
        fi
        # clean train.log
