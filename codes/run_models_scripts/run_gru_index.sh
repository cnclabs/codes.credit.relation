...
do
    echo fold $i
    python ./explainable_credit/codes/main.py --model_dir=./explainable_credit/$exp_dir_name/gru01_index/index_fold_${i} --data_dir=./data/8_labels_index/len_01/index_fold_${i} --num_epochs 300 --device=$3 --batch_size $1 --shared_param --patience $4 --learning_rate $6 --lstm_num_units $7 --weight_decay $8 --num_layers $9 --dropout_rate ${10}
done
...
do
    echo fold $i
    python ./explainable_credit/codes/main.py --model_dir=./explainable_credit/$exp_dir_name/gru06_index/index_fold_${i} --data_dir=./data/8_labels_index/len_06/index_fold_${i} --num_epochs 300 --device=$3 --batch_size $1 --shared_param --patience $4 --learning_rate $6 --lstm_num_units $7 --weight_decay $8 --num_layers $9 --dropout_rate ${10}
done
...
# do
#     echo fold $i
#     python ./explainable_credit/codes/main.py --model_dir=./explainable_credit/$exp_dir_name/gru12_index/index_fold_${i} --data_dir=./data/8_labels_index/len_12/index_fold_${i} --num_epochs 300 --device=$3 --batch_size $1 --shared_param --patience $4 --learning_rate $6 --lstm_num_units $7 --weight_decay $8 --num_layers $9 --dropout_rate ${10}
# done
